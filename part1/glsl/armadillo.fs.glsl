...
void main() {
	...
	vec3 baseColor = intensity * vec3(1.0, 1.0, 1.0); // white color
	vec3 cyanColor = intensity * vec3(0.0, 1.0, 1.0); // cyan color
	...
	// Adjust this value to control detection range, we need gap to be able to see the character clearly.
